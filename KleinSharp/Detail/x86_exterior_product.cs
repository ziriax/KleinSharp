...
namespace KleinSharp
{
	internal static partial class Detail
	{
		...
		public static void ext00(__m128 a, __m128 b, out __m128 p1_out, out __m128 p2_out)
		{
			// (a1 b2 - a2 b1) e12 +
			// (a2 b3 - a3 b2) e23 +
			// (a3 b1 - a1 b3) e31 +
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void extPB(__m128 a, __m128 b, out __m128 p3_out)
		{
		...
		// p0 ^ p2 = p2 ^ p0
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void ext02(__m128 a, __m128 b, out __m128 p3_out)
		{
			// (a1 b2 - a2 b1) e021
			// (a2 b3 - a3 b2) e032 +
			// (a3 b1 - a1 b3) e013 +
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void ext03(bool flip, __m128 a, __m128 b, out __m128 p2)
		{
